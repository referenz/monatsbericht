...
function Vergleich(props: {
    ...
    const monatsbericht_alt = Monatsbericht.fromArrayBuffer(
    ...
    return (
        <Container className={props.className + ' vergleich'}>
            ...
            <VergleichBezeichnungen
                monatsbericht_neu={props.monatsbericht.current}
                monatsbericht_alt={monatsbericht_alt}
            />

            <VergleichProjektzahl
                monatsbericht_neu={props.monatsbericht.current}
                monatsbericht_alt={monatsbericht_alt}
            />
        </Container>
